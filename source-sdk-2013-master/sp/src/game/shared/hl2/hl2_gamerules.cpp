...
ConVar	sk_plr_incarcerator_damage("sk_plr_incarcerator_damage", "0", FCVAR_REPLICATED);
ConVar	sk_npc_incarcerator_damage("sk_npc_incarcerator_damage", "0", FCVAR_REPLICATED);
ConVar	sk_max_incarcerator_round("sk_max_incarcerator_round", "0", FCVAR_REPLICATED);
...
ConVar	sk_plr_num_quad_pellets("sk_plr_num_shotgun_pellets", "10", FCVAR_REPLICATED);
...
CAmmoDef *GetAmmoDef()
{
	...
	if ( !bInitted )
	{
		...
		def.AddAmmoType("IncarceratorEnergy",		DMG_ENERGYBEAM | DMG_DISSOLVE,			TRACER_NONE,			"sk_plr_incarcerator_damage", "sk_npc_incarcerator_damage", "sk_max_incarcerator_round", BULLET_IMPULSE(650, 8000), 0);
